...
<div class="bg-dark py-5" style=margin-bottom:100px>
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">궐련형담배</h1>
...
<c:otherwise>
    <div class="container">
        <button type="submit" class="btn btn-success"><a href="/product1/save1">궐련형담배</a></button>
    </div>
</c:otherwise>
</c:choose>
<div class="col mb-5">
                ...
                <div class="col">
                    <table>
                        <div class="container" style="margin-left: 500px">
                            ...
                            <tr>
                                <td>
                                    <a href="/product3/put3?p3_id=${productList.p3_id}" class="btn btn-success">장바구니에담기</a>
                                </td>
                            </tr>
                        </div>
                    </table>
