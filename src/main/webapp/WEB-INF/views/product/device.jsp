...
<c:otherwise>
    <div class="container">
        <button type="submit" class="btn btn-success"><a href="/product2/save1">상품등록</a></button>
    </div>
</c:otherwise>
</c:choose>
<div class="col mb-5">
    ...
    <div class="card h-100">
        <div class="row">
            <div class="col">
                <div class="container">
                    <img src="${pageContext.request.contextPath}/upload/${productList1.productFileName1}" alt=""
                         height="400"
                ...
                <div class="col">
                    <table>
                        <div class="container" style="margin-left: 500px">
                            <tr>
                                <th><h3>1.상품명:${productList.productName2}</h3></th>
                            </tr>
                            <tr>
                                <td><h3>2.가격:${productList.productPrice2}&nbsp;원</h3></td>
                            </tr>
                            <tr>
                                <td><h3>3.재고:${productList.productStock2}개</h3></td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="/product2/put2?p2_id=${productList.p2_id}" class="btn btn-success">장바구니에담기</a>
